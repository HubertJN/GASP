...
plt.tight_layout()
plt.savefig(f"{config.paths.plot_dir}/committor_histogram_{beta:.3f}_{h:.3f}.pdf")
print(f"Saved committor histogram to {config.paths.plot_dir}/committor_histogram_{beta:.3f}_{h:.3f}.pdf")
plt.close()
...
plt.tight_layout()
plt.savefig(f"{config.paths.plot_dir}/cluster_committor_{beta:.3f}_{h:.3f}.pdf")
print(f"Saved committor histogram to {config.paths.plot_dir}/cluster_committor_{beta:.3f}_{h:.3f}.pdf")
plt.close()
